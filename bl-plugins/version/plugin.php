...
class pluginVersion extends Plugin
{
	...
	public function adminSidebar()
	{
		...
		if ($this->getValue('showCurrentVersion')) {
			$html = '<a id="current-version" class="current-version nav-link" href="' . HTML_PATH_ADMIN_ROOT . 'about' . '">' . $L->get('Version') . ' <span class="badge bg-warning rounded-pill">' . BLUDIT_VERSION . '</span></a>';
		}
